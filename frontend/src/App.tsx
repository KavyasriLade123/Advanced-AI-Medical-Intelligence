    ...
    <div className="app-shell">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p>
            Upload a medical image for deep-learning triage (chest pneumonia or bone fracture),
            Grad-CAM explanation, and an AI-assisted clinical report.
          </p>
          <div className="cta-row">
            ...
            <button
              ...
              type="button"
              onClick={() => document.getElementById("history-panel")?.scrollIntoView({ behavior: "smooth" })}
            >
              View history
            </button>
          </div>
      ...
      <main className="workspace" ref={workspaceRef}>
        <section className="panel">
          ...
          <p className="lede">
            Supported body regions (top to bottom style): Brain, Eye/Retina, Breast, Chest X-ray,
            Abdomen, Skin, Bone fracture, Lower limb. Unrelated images are rejected — please upload
            a correct medical image. Predictions are decision support only.
          </p>
        ...
        {result ? (
          <section className="panel grid-2">
            <div>
              ...
              <p className="lede">Original study beside Grad-CAM heatmap for the predicted class.</p>
      ...
      <p className="footnote">
        ...
        If an image is unrelated to trained body regions, the app rejects it and asks you to upload a correct medical image.
      </p>
    </div>
  );
}
